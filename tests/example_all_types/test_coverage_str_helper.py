...
@pytest.mark.parametrize(
    ...
    [
        (
            [1282, 1283, 1284, 1285, 1286, 1287, 1288, 1295, 1296, 1258, 1270, 1279],
            {1280, 1278, 1260, 1268},
            "['1282-1288', '1295-1296', '1258', '1270']",
            {
                "this_list": "[1282, 1283, 1284, 1285, 1286, 1287, 1288, 1295, 1296, 1258, 1270, 1279]",
