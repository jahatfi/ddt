...
@pytest.mark.parametrize(
    ...
    [
        (
            [1280, 1283, 1284, 1285, 1286, 1287, 1288, 1289, 1296, 1297, 1259, 1271],
            {1281, 1279, 1261, 1269},
            "['1280', '1283-1289', '1296-1297', '1259']",
            {
                "this_list": "[1280, 1283, 1284, 1285, 1286, 1287, 1288, 1289, 1296, 1297, 1259, 1271]",
