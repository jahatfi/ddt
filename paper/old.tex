...
caption={Overwriting incompatible \textit{repr} method},label={lst:pandas_repr},]{examples/pandas\_repr.py}
...
\lstinputlisting[language=Python,numbers=left,
  caption={decorator.py: A sample decorator that takes one argument.},label={lst:decorator},]{examples/decorator.py}
...
\lstinputlisting[language=bash,numbers=left,
  caption={Output of decorator.py},label={lst:decorator-output},]{examples/decorator\_result.txt}
\lstset{style=pythonstyle}
...
\lstinputlisting[language=TeX,numbers=left,
  caption={Result of Programmatically Disassembling \textit{add\_ints}},label={lst:dissas-add-ints},]{examples/actual\_disassemble\_add\_ints.txt}
...
\lstinputlisting[language=Python,numbers=left,
  caption={Calling a function and capturing the test coverage with the \textit{coverage} module.},label={lst:Coverage},]{examples/coverage_example.py}
...
\lstinputlisting[language=Python,numbers=left,
  caption={The CoverageInfo class caches all metadata associated with a single execution.},label={lst:CoverageInfo},]{examples/coverage_info.py}
...
\lstinputlisting[language=Python,numbers=left,
  caption={The FunctionMetaData class caches all metadata associated with
   a single function, to include all associated CoverageInfo classes (line 25)},label={lst:FunctionMetaData},]{examples/function\_metadata.py}
...
\lstinputlisting[language=Python,numbers=left,
  ...
  the function results when desired coverage met},label={lst:ProgrammaticallyTuning},]{examples/programmatictuning.py}
...
\lstinputlisting[language=Python,numbers=left,
  caption={limit\_recursion.py},label={lst:Limit Recursion},]{examples/limit_recursion.py}
...
\lstinputlisting[language=Python,numbers=left,
  caption={divide\_ints.py},label={lst:Divide Ints},]{examples/divide\_ints\_1.py}
...
\lstinputlisting[language=Python,numbers=left,
  caption={test divide\_ints()},label={lst:Test Divide Ints},]{examples/divide\_ints\_2.py}
...
\lstinputlisting[language=Python,numbers=left,
  caption={test divide\_ints},label={lst:Test Divide Ints},]{examples/divide\_ints\_3.py}
