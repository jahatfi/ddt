"""
Programmatically generated test 
function for divide_ints()
"""
...
# In sum, these tests covered 
# 100.0% of divide_ints's lines
@pytest.mark.parametrize(
    "a, b, exception_type, exception_message, \
    expected_result, expected_type, args_after, \
...
def test_divide_ints(
    ...
    if exception_type != "N/A":
        ...
        assert result == expected_result \
            or result == eval(expected_result)
