...
\lstinputlisting[%
  language=Python,%
  numbers=left,
  caption={Programmatically disabling the decorator by immediately returning the function results when desired coverage met},%
...
The \textit{auto\_generate\_tests} function in the associated repo performs this 
